...
export const TileButton: React.FunctionComponent<React.PropsWithChildren<ITileButton>> = (props) => {
  const backgroundImage = {
    background: "linear-gradient(0deg, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(" + props.backgroundImage + ")"
  }
